...
ha_LeftButton * ha_LeftButton_init(ha_LeftButton * const self) {
    ...
    GPIOPadConfigSet(ha_LeftButton_port, ha_LeftButton_pin, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
    return self;
}
...
void ha_LeftButton_registerInt(ha_LeftButton * const self, void (*const fun)(void)) {
    ha_per_PortF_registerLButtonInt(ha_per_PortF_(), fun);
}
